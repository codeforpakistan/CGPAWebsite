    ...
    <div class="container bg-gray-light">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <p>
            Privilege motion refers to where a Member feels that the privilege of any MPA or a Committee or himself, has
            been breached, and raises a question regarding that breach of privilege with the consent of the Speaker.
          </p>
          <h4 class="text-uppercase">
            Methodology
          </h4>
          <p>
            The data for privilege motion scores was analysed by aggregating all available data on privilege motions forwarded
            and calculating the percentage of each individual legislator to total privilege motions forwarded. This gives a
            perfect picture of how much each individual MPA has contributed to the total privilege motions forwarded.
          </p>
          <br />
              ...
              <div id="scoreTable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <tbody>
<?php
                      Utils::HTMLForTable($MessageLog, $ResultSet, array("mpaName", "plpPoliticalPartyID", "cntConstituencyID", "PrivilegeMotions", "PrivilegeMotionsRank", "PrivilegeMotionsPercent"), array("even", "odd"));
?>
                    </tbody>
                  </table>
                </div>
