        ...
        <div class="col-xs-12">
          <div class="info-box bg-green">
            ...
            <div class="info-box-content">
              <h3>Resolution Scorecard</h3>
              <div class="progress">
                <div class="progress-bar" style="width: 100%"></div>
              </div>
              <span class="progress-description">
                This page shows the number of resolutions each legislators has participated in. Feel free to sort and filter data however you may choose.
              </span>
            </div>
            <!-- /.info-box-content -->
          </div>
