    ...
    <div class="container bg-gray-light">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <p>
            In the assembly, a motion of a single member becomes a resolution of the whole meeting if it carries or obtains
            a necessary number of votes. It is primarily a declaration and showcases how the parliamentary leadership
          ...
          <p>
            The data for resolution scores was analysed by aggregating all available data on resolutions introduced and
            calculating the percentage of each individual legislator to total resolutions introduced. This gives a perfect
            picture of how much each individual MPA has contributed to the total resolutions introduced.
          </p>
          <br />
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header bg-gray disabled">
              <h3 class="box-title">Resolution Participation Scores</h3>
            </div>
            <div class="box-body">
