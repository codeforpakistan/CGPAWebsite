        ...
        <div class="col-xs-12">
          <div class="info-box bg-red-active">
            ...
            <div class="info-box-content">
              <h3>Call for Attention Scorecard</h3>
              <div class="progress">
                <div class="progress-bar" style="width: 100%"></div>
              </div>
              <span class="progress-description">
                This page shows the number of call for attentions each legislators has initiated. Feel free to sort and filter data however you may choose.
              </span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Call Attention Notice Scores</h3>
            </div>
            <div class="box-body">
